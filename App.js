    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Input placeholder="disabled input" disabled value="Disable Input"/>
                <Input placeholder="normal error input" error value="enter error info"/>
                ...
                <Input placeholder="inline error input" singleLine error keyboardType="email-address"  value="enter error info"/>
